...
const comments = [
  {
    id: 1,
    comment: 'Every work deserves its respect, not only delivery. Do we respect the cook who is standing in the heat all day to prepare the food they take….lets not talk more or less of any job….every job has its own good and bad associated.',
    author: 'Author auth',
      ...
      <div className={styles['post-card-wrapper']}>
        <header>
          ...
          <div>
            ...
            )} | ${data._hobby.display} ${data?._genre?.display ? `| ${data?._genre?.display}` : ''
              }`}</p>
          </div>
          <svg
        ...
        <footer>
          <section className={styles['footer-actions-wrapper']}>
            ...
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <circle cx="12" cy="12" r="11.25" fill="white" stroke="#8064A2" stroke-width="1.5" />
