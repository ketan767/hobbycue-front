    ...
    <>
      <section className={`site-container ${styles['add-listing-container']}`}>
        <h1 className={styles['add-listing-heading']}>
          ...
          >
            <g clip-path="url(#clip0_173_53831)">
              <path
          ...
          <section className={`${styles['card']} ${styles['program']}`}>
            <h3>
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clip-path="url(#clip0_173_53869)">
                  <rect x="8" y="13" width="24" height="19" fill="#0096C8" />
                  <path
                    d="M26.6667 17.5474C26.1833 17.0641 25.3833 17.0641 24.9 17.5474L17.65 24.7974L15 22.1474C14.5167 21.6641 13.7167 21.6641 13.2333 22.1474C12.75 22.6307 12.75 23.4307 13.2333 23.9141L16.4667 27.1474C17.1167 27.7974 18.1667 27.7974 18.8167 27.1474L26.65 19.3141C27.15 18.8307 27.15 18.0307 26.6667 17.5474ZM31.6667 4.9974H30V3.33073C30 2.41406 29.25 1.66406 28.3333 1.66406C27.4167 1.66406 26.6667 2.41406 26.6667 3.33073V4.9974H13.3333V3.33073C13.3333 2.41406 12.5833 1.66406 11.6667 1.66406C10.75 1.66406 10 2.41406 10 3.33073V4.9974H8.33333C6.48333 4.9974 5.01667 6.4974 5.01667 8.33073L5 31.6641C5 33.4974 6.48333 34.9974 8.33333 34.9974H31.6667C33.5 34.9974 35 33.4974 35 31.6641V8.33073C35 6.4974 33.5 4.9974 31.6667 4.9974ZM30 31.6641H10C9.08333 31.6641 8.33333 30.9141 8.33333 29.9974V13.3307H31.6667V29.9974C31.6667 30.9141 30.9167 31.6641 30 31.6641Z"
                    fill="#0096C8"
                  />
                  <path
