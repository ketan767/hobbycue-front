  ...
  return (
    <>
      <Head>
        ...
        <title>HobbyCue - Intern Links</title>
      </Head>
      <div className={styles.container}>
        <div className={styles.dataSection}>
          <div className={styles.about}>
            ...
            <ul>
              <li>
                Always login to see all accessible menu options on hobbycue.com
              </li>
              <li>
            ...
            <h4>
              <strong>Adding Listing Content:</strong>
            </h4>
            <ul>
              <li>To access Listings you have added …</li>
            ...
            <ul style={{ marginLeft: '10px' }}>
              <li>
                ...
                1) Info about guru(s) from whom they learned. <br />
                2) Top performances, awards and contribution. <br />
                3) Key students, school, teaching related info.
              </li>
              <li>
                Readability and SEO scores and comments (scroll down on back-end
                editor)
              </li>
              <li>
                Follow consistent spelling of Indian words. For keywords use the
                first Wikipedia spelling.
              </li>
              <li>
                Never include a space before a comma or full-stop. Always
                include a space after a comma or full-stop. This applies
                everywhere: title, description, address, multiple phone numbers
              </li>
              <li>
                Do not include a full-stop after initials. Eg: “D K Pattammal”
                instead of “D. K. Pattammal”
              </li>
              <li style={{ marginLeft: '-10px' }}>
                For images, follow the following:
              </li>
              <li>
                Get Square Profile Pic, Long Cover Image, and 4:3 ratio on Other
                Gallery Pics.
              </li>
              <li>
                For a Person, the Profile Pic could be a close-up of face. For a
                Place, the Profile Pic could be a close-up of brand name or
                logo. The Cover Image could ideally be a stage performance
                and/or pic of class or students.
              </li>
              <li>
                PNG is preferred file type. If not, use JPG. Optimise to a file
                size of 300K.
              </li>
              <li>
                Rename the image files to contain the Listing name and keywords
                followed by a number if needed. eg: “Meena-Murthy-Carnatic.png”
                or “Meena-Murthy-Veena-1.png”. Here, the keyword Carnatic or
                Veena is added, because a Google search on just “Meena Murthy”
                goes to a different profile.
              </li>
              <li style={{ marginLeft: '-10px' }}>Other sections:</li>
              <li>
                In the Video URL, add only an individual video link so that it
                can play. If you want to add a link to a YouTube channel, do so
                under the Social Media link section.
              </li>
              <li>
                If you are adding a Social Media link or taking a photo from
                there, please ensure that it is primarily a professional one and
                not a personal profile photo (eg: mostly with family and
                friends).
              </li>
              <li>
                Capture referenced and useful links in the Notes section of the
                Listing.
              </li>
              <br />
              <hr />
            ...
            <div style={{ width: '100%' }}>
              ...
              <br />
              <p>
                Let us know if something is missing and we’ll add.{' '}
                <a target="_blank" href="mailto:info@hobbycue.com">
                  mailto:info@hobbycue.com
                </a>
              </p>
            </div>
          </div>
