    ...
    <div className={styles.container}>
        <div className={styles.dataSection}>
            <div className={styles.about}>
                <h1>Team</h1>
                <p><span className='font-semibold'>Purnima</span> and <span className='font-semibold'>Bhaskar</span> are a couple who co-founded <span className='font-italic'><strong>hobbycue</strong>.com</span>  Their venture is bootstrapped, with a lot of support from family and friends.  They are currently incubated as part of the Government of Karnataka supported <strong>NASSCOM 10K Startup</strong> Warehouse at Diamond District, Bangalore.  The company is registered as <strong>Purple Cues</strong> Private Limited.</p>
                <div className={styles.imgContent}>
                    <img src="http://blog.hobbycue.com/wp-content/uploads/2018/06/Purnima-Pic.png" alt="Purnima Sambasivan, Co-Founder" />
                    <div>
                        <h2>Purnima Sambasivan, Multi Tasker and Co-Founder</h2>
                        <p>Purnima is an adept multi-tasker, and a supermom of two girls.  She has done her Master’s in Computer Applications from Madras University.  Since starting her career in the IT industry as a developer, she has grown over time into project management.  As part of this, she also took appropriate breaks to focus on her family.</p>
                    </div>
                </div>
                <p>Purnima has learnt Carnatic music and Bharatanatyam, and continues her passion through practice, performances, and helping organise events.  She also encourages her daughters to pursue Sports, Games, Art, Music (Western & Indian) and Dance (Bharatanatyam), and actively participates with them in workshops and practice sessions.</p>
                <p>Purnima is an avid explorer and has travelled across various continents and countries over the years.  She often springs a good crop from her home garden, and recently became a proud mom of a pug puppy who is adding joy to the family.</p>
                <div className={styles.imgContent}>
                    <img src="http://blog.hobbycue.com/wp-content/uploads/2018/06/Bhaskar-Pic.png" alt="Bhaskar Subramanian, Co-Founder" />
                    <div>
                        <h2>Bhaskar Subramanian, Chief Hobbyist and Co-Founder</h2>
                        <p>Bhaskar is a seasoned IT professional with over 2 decades of rich experience across industry verticals and process areas.   An alumnus of IIT Kanpur, Bhaskar has worked for clients across the globe in industry domains such as Document Management, Electric Utilities, Oil & Gas, Telecom & Media and Travel & Leisure.   On the process side, he has worked on Strategic Business Planning, Program Management, Delivery Management, PreSales and Marketing Support, Automation & Artificial Intelligence.</p>
                    </div>
                </div>
                <p>Bhaskar has been learning violin from his school days and continues to attend weekly classes.  He picked up keyboards and guitars by himself and even started giving backing vocals in his rock band.  With a ear for music, you can find him pick up chord progressions at ease.  He is keen to experience different places and cultures, and has planned travel with family to over 10 different countries and multiple regions within India.   Bhaskar is also an avid photographer and collects memories from his travels.</p>
                <p>Occasionally, you’ll find Bhaskar dish out an awesome Italian cuisine, or run a 10K.  He has created several pieces of pencil art and has an eye for design.  You can find many of his experiences through his blog on hobbycue.com.</p>
                <img src="https://blog.hobbycue.com/wp-content/uploads/2019/07/Team-hobbycue-600x400.jpg" alt="Purnima and Bhaskar" />
            </div>
