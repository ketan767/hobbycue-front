...
export default function Index() {
  ...
  const updateTitle = async () => {
    try {
      ...
      const data = await updateOtherPage('services', formData)
  ...
  useEffect(() => {
    const fetchBrands = async () => {
      const result = await GetOtherPage('services')
        ...
        <div className={styles.container}>
          ...
          <div className={styles.dataSection}>
            <div className={styles.about}>
              <h1>Services</h1>
              <p>
                Our services revolve around a Community recommended offering of
                4 Ps – People, Places, Products, and Programs.
              </p>
