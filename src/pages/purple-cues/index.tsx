        ...
        <div className={styles.dataSection}>
          <div className={styles.about}>
            ...
            <h2>
              ...
              <span className={styles['sky']}>Cues</span> Private Limited
            </h2>
            <ul>
              <li>
              ...
              <li>
                ...
                represents ambition, creativity, magic, royalty{' '}
              </li>
              <li>
                <span className={styles['purple']}>
                  <strong>Purple</strong>
                </span>{' '}
                is the colour of the year 2018{' '}
              </li>
              <li>
                <span className={styles['sky']}>
                  <strong>Cue</strong>
                </span>{' '}
                is a guiding suggestion or a hint
              </li>
              <li>
                <span className={styles['sky']}>
                  <strong>Cue</strong>
                </span>{' '}
                is a prompt or a stimulus for action{' '}
              </li>
            </ul>
